...
with DAG(dag_id='weather_etl_pipeline',
    ...
    def load_weather_data(transformed_data):
        ...
        cursor.close()
        conn.close()  # Add this to properly close the connection.
    ...
    """If port already in use message comes then use these steps
    
    Identify what is running in port 5432: sudo lsof -i :5432

    Kill all the processes that are running under this port: sudo kill -15 <pid>
